...
\begin{document}
  ...
  \begin{frame}[plain]{Technology}
    ...
    \begin{itemize}
      \item Python Flask\textsuperscript{\hyperlink{link-flask}{\arabic{index}}} application providing the API
      \stepcounter{index}
      \item Selenium\textsuperscript{\hyperlink{link-selenium}{\arabic{index}}} web scraper searching for new protocols
      \stepcounter{index}
      \item TextBlob\textsuperscript{\hyperlink{link-textblob}{\arabic{index}}} for sentiment analysis of speeches
      \stepcounter{index}
